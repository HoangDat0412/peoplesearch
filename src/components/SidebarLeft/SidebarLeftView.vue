...
<template>
  <main>
    <div class="sidebar px-0 d-none d-xl-block">
      <div style="text-align: right; position: absolute; right: 21px; top: 10px">
        <font-awesome-icon
      ...
      <div class="d-flex flex-column align-items-center px-2 px-sm-3 pt-3 min-vh-100">
        <ul class="nav nav-pills flex-column mb-0 align-items-center mt-4" id="menu">
          <RouterLink to="/" class="nav-item">
            ...
            >
              ...
              <div v-if="show.showSidebar" class="d-none d-sm-block flex gap-3">
        ...
        <PerfectScrollbar style="height: 74vh">
          <ul v-if="show.showSidebar" class="mt-2">
            <ChatTitle />
          </ul>
        </PerfectScrollbar>

        <div v-if="user?.userInformation?.current_user_name" class="mt-auto dropdown pb-4">
          <a
            href="#"
          ...
          >
            ...
            />
            <span v-if="show.showSidebar" class="d-none d-sm-inline mx-1 ms-2">loser</span>
          </a>
        ...
        <div v-else class="mt-auto mb-2">
          <RouterLink class="btn_2" to="/login">Login</RouterLink>
        </div>
      </div>
    </div>
  </main>
