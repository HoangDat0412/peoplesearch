...
const searchFile = () => {
  notify({
    title: `Can't search, This functionality is currently in development`,
    textL: 'This functionality is currently in development',
    type: 'error'
  })

  // Implement the file search logic here
  //   notify({
  //     title: `Search initiated with message: ${message.value}`,
  //     type: 'error'
  //   })
}
